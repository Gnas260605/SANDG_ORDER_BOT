...
const SERVICES = {
  ...
  REROLL: {
    ...
    description: "Cày Reroll (10.000 VNĐ / 50 Reroll)",
    displayPrice: "10.000 VNĐ / 50 Reroll",
    minQuantity: 1,
    maxQuantity: 1000,
  },
  TOKEN_EVENT_ITACHI: {
    ...
    unitPrice: 10000,
    unitLabel: "Gói (80K Token)",
    description: "Cày Token Event Itachi (10.000 VNĐ / 80K Token)",
    displayPrice: "10.000 VNĐ / 80K Token",
    minQuantity: 1,
    maxQuantity: 1000,
  },
  RAID: {
